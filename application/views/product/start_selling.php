						...
						<div class="col-12 col-md-12 col-lg-10">
							...
							<?php if ($this->auth_check):
								...
								<?php else: ?>
									<div class="row">
										<div class="col-12">
											<?php echo form_open_multipart('product_controller/start_selling_post', ['id' => 'form_validate', 'class' => 'validate_terms', 'onkeypress' => "return event.keyCode != 13;"]); ?>
											...
											<div class="form-box m-b-15">
												...
												<div class="form-box-body">
													...
													<div class="form-group">
														<div class="row">
															<div class="col-12 col-sm-6 m-b-15 hidden">
															...
															<div class="col-12 col-sm-6 m-b-15 hidden">
																...
																<div class="selectdiv">
																	<select id="states" name="state_id" class="form-control" onchange="get_cities(this.value);" required>
																		<option value=""><?php echo trans('select'); ?></option>
																		<?php
																		$states = get_states_by_country('102');
																		if (!empty($states)):
															...
															<div class="col-12 col-sm-6 m-b-15">
																<div class="row">
																	...
																	<div class="col-auto">
																		<a href="#" class="small text-primary">Verifikasi</a>
																	</div>
																</div>
