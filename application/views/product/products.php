...
<div id="wrapper">
	<div class="container">
		...
		<?php if(isset($item_category)): ?>
			<?php if(get_category_image_url($item_category, 'image_3') != base_url()): ?>
			<img style="width:100%;height:200px;object-fit:cover" src="<?php echo $img_bg_product_small; ?>" data-src="<?php echo get_category_image_url($item_category, 'image_3'); ?>" alt="<?php echo html_escape($item_category->name); ?>" class="lazyload img-fluid">
			<br><br>
			<?php endif; ?>
		<?php endif; ?>
