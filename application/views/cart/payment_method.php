										...
										<div class="col-12">
											<div class="form-group">
												<ul class="payment-options-list">
													...
													<?php if($this->auth_user->balance > 0): ?>
													<li>
														<div class="option-payment">
															<div class="custom-control custom-radio">
																<input type="radio" class="custom-control-input" id="option_saldo" name="payment_option" value="saldo" required <?php echo ($check_option == true) ? 'checked' : ''; ?>>
																<label class="custom-control-label label-payment-option" for="option_saldo">Potong Saldo<br><small>Saldo Anda : <?= print_price($this->auth_user->balance, 'IDR') ?></small></label>
															</div>
														</div>
													</li>
													<?php endif; ?>
