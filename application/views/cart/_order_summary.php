...
<div class="col-sm-12 col-lg-5 order-summary-container">
	...
	<div class="right">
						...
						<div class="item">
							...
							<div class="item-right">
								...
								<div class="list-item m-t-15">
									...
									<strong class="lbl-price quantity_pd"><?php echo $cart_item->quantity; ?></strong>
								</div>
								<div class="list-item">
									<label><?php echo trans("price"); ?>:</label>
									<strong class="lbl-price harga_pd"><?php echo print_price($cart_item->total_price, $cart_item->currency); ?></strong>
								</div>
								<?php if ($product->product_type != 'digital' && $this->form_settings->shipping == 1): ?>
									<div class="list-item">
										<label><?php echo trans("shipping"); ?>:</label>
										<strong class="ongkir_pd"><?php echo print_price($cart_item->shipping_cost, $cart_item->currency); ?></strong>
									</div>
								<?php endif; ?>
		...
		<p class="m-t-30">
			<strong><?php echo trans("subtotal"); ?><span class="float-right subtotal_pd"><?php echo print_price($cart_total->subtotal, $this->payment_settings->default_product_currency); ?></span></strong>
		</p>
		<?php if ($is_physical  && $this->form_settings->shipping == 1): ?>
			<p>
				<?php echo trans("shipping"); ?><span class="float-right ongkirtotal_pd"><?php echo print_price($cart_total->shipping_cost, $this->payment_settings->default_product_currency); ?></span>
			</p>
		<?php endif; ?>
