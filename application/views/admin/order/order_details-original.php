                    ...
                    <div class="row">
                        <div class="col-sm-12 col-md-12 col-lg-6">
                            ...
                            <div class="row row-details">
                                ...
                                <div class="col-sm-8">
                                    <strong class="font-right"><?php echo get_provinsi_id($shipping->billing_state); ?></strong>
                                </div>
                            </div>
                            <div class="row row-details">
                                <div class="col-xs-12 col-sm-4 col-right">
                        ...
                        <div class="col-sm-12 col-md-12 col-lg-6">
                            ...
                            <div class="row row-details">
                                ...
                                <div class="col-sm-8">
                                    <strong class="font-right"><?php echo get_provinsi_id($shipping->shipping_state); ?></strong>
                                </div>
                            </div>
                            <div class="row row-details">
                                <div class="col-xs-12 col-sm-4 col-right">
