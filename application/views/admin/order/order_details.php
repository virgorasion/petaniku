...
<div class="row">
                ...
                <div class="row" style="margin-bottom: 30px;">
                    <div class="col-sm-12 col-md-12 col-lg-6">
                        ...
                        <div class="row row-details">
                            ...
                            <div class="col-sm-8">
                                <strong
                                    class="font-right"><?php echo $order->updated_at; ?>&nbsp;(<?php echo time_ago($order->updated_at); ?>)</strong>
                            </div>
                        </div>
                        <div class="row row-details">
                            <div class="col-xs-12 col-sm-4 col-right">
                            ...
                            <div class="col-sm-8">
                                <strong
                                    class="font-right"><?php echo $order->created_at; ?>&nbsp;(<?php echo time_ago($order->created_at); ?>)</strong>
                            </div>
                        </div>
                    </div>
                    <div class="col-sm-12 col-md-12 col-lg-6">
                        ...
                        <div class="row row-details">
                            <div class="col-xs-12">
                                <div class="table-orders-user">
                                    <img src="<?php echo get_user_avatar(null); ?>" alt="" class="img-responsive"
                                        style="height: 120px;">
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="row row-details">
                            ...
                            <div class="col-sm-8">
                                <strong
                                    class="font-right"><?php echo $shipping->shipping_first_name . " " . $shipping->shipping_last_name; ?>
                                    <label class="label bg-olive"><?php echo trans("guest"); ?></label></strong>
                            </div>
                        </div>
                        <div class="row row-details">
                            <div class="col-xs-12 col-sm-4 col-right">
                ...
                <div class="row">
                    ...
                    <div class="col-sm-12 col-md-12 col-lg-6">
                        ...
                        <div class="row row-details">
                            ...
                            <div class="col-sm-8">
                                <strong
                                    class="font-right"><?php echo get_provinsi_id($shipping->billing_state); ?></strong>
                            </div>
                        </div>
                        <div class="row row-details">
                            <div class="col-xs-12 col-sm-4 col-right">
                            ...
                            <div class="col-sm-8">
                                <strong class="font-right"><?php echo get_kota_id($shipping->billing_city); ?></strong>
                            </div>
                        </div>
                        <div class="row row-details">
                            <div class="col-xs-12 col-sm-4 col-right">
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div class="img-table" style="height: 67px;">
                                                <a href="<?php echo base_url() . $item->product_slug; ?>"
                                                    target="_blank">
                                                    <img src="<?php echo get_product_image($item->product_id, 'image_small'); ?>"
                                                        data-src="" alt="" class="lazyload img-responsive post-image" />
                                                </a>
                                            </div>
                                            <p>
                                        ...
                                        <td><?php echo print_price($item->product_unit_price, $item->product_currency); ?>
                                        </td>
                                                ...
                                                <ul class="dropdown-menu options-dropdown">
                                                    <li>
                                                        <a href="#" data-toggle="modal"
                                                            data-target="#updateStatusModal_<?php echo $item->id; ?>"><i
                                                                class="fa fa-edit option-icon"></i><?php echo trans('update_order_status'); ?></a>
                                                    </li>
                                                    <li>
                                                        <a href="javascript:void(0)"
                                                            onclick="delete_item('order_admin_controller/delete_order_product_post','<?php echo $item->id; ?>','<?php echo trans("confirm_delete"); ?>');"><i
                                                                class="fa fa-times option-icon"></i><?php echo trans('delete'); ?></a>
                                                    </li>
                                                </ul>
                                            </div>
                                            <?php endif; ?>
    ...
    <div class="col-sm-12">
        <div class="box-payment-total">
            ...
            <!-- <div class="row row-details">
                <div class="col-xs-12 col-sm-6 col-right">
                    <strong><?= trans('kode_unik') ?></strong>
                </div>
                <div class="col-sm-6">
                    <strong
                        class="font-right"><?= (isset($order->kodeunik)) ? $order->kodeunik  : 0 ?></strong>                    
                </div>
            </div> -->
            ...
            <div class="row row-details">
                ...
                <div class="col-sm-6">
                    <strong
                        class="font-right"><?php echo print_price($order->price_total, $order->price_currency); ?></strong>
                </div>
            </div>
        </div>
    </div>
