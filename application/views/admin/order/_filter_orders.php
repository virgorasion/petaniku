        ...
        <div class="item-table-filter">
            ...
            <select name="status" class="form-control">
                ...
                <option value="completed"
                    <?php echo ($this->input->get('status', true) == 'completed') ? 'selected' : ''; ?>>
                    <?php echo trans("completed"); ?></option>
                <option value="processing"
                    <?php echo ($this->input->get('status', true) == 'processing') ? 'selected' : ''; ?>>
                    <?php echo trans("order_processing"); ?></option>
            </select>
        </div>
        ...
        <div class="item-table-filter">
            ...
            <select name="payment_status" class="form-control">
                ...
                <option value="payment_received"
                    <?php echo ($this->input->get('payment_status', true) == 'payment_received') ? 'selected' : ''; ?>>
                    <?php echo trans("payment_received"); ?></option>
                <option value="awaiting_payment"
                    <?php echo ($this->input->get('payment_status', true) == 'awaiting_payment') ? 'selected' : ''; ?>>
