			...
			<div class="box-body">
				...
				<?php foreach ($languages as $language): ?>
					<div class="form-group">
						...
						<input type="text" class="form-control" name="name_lang_<?php echo $language->id; ?>" placeholder="<?php echo trans("category_name"); ?>"
							   value="<?php echo $this->category_model->get_category_name_by_lang_not_completed($category->id, $language->id); ?>" maxlength="255" required>
					</div>
				<?php endforeach; ?>
				...
				<div class="form-group">
					<div class="row">
						...
						<div class="col-sm-4 col-xs-12 col-option">
							<input type="radio" name="show_icon" value="1" class="square-purple" <?php echo ($category->show_icon == '1') ? 'checked' : ''; ?>>
							<label  class="option-label"><?php echo trans('yes'); ?></label>
						</div>
						<div class="col-sm-4 col-xs-12 col-option">
							<input type="radio" name="show_icon" value="0" class="square-purple" <?php echo ($category->show_icon == '0') ? 'checked' : ''; ?>>
							<label class="option-label"><?php echo trans('no'); ?></label>
						</div>
					</div>
				</div>
				...
				<div class="form-group">
					...
					<?php if (!empty($category->icon)): ?>
						<div class="display-block m-b-15">
							<img src="<?php echo get_category_image_url($category, 'icon'); ?>" alt="" style="height: 200px;">
						</div>
					<?php endif; ?>
					<div class="display-block">
						<a class='btn btn-success btn-sm btn-file-upload'>
							<?php echo trans('select_image'); ?>
							<input type="file" id="Multifileupload2" name="file_icon" size="40" accept=".png, .jpg, .jpeg, .gif">
						</a>
					</div>

					<div id="MultidvPreview2" class="image-preview"></div>
				</div>
