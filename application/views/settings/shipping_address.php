                ...
                <div class="row-custom">
                    <div class="profile-tab-content">
                        ...
                        <div class="form-group">
        					...
        					<textarea name="shipping_address_1" class="form-control form-input" placeholder="<?php echo trans("address"); ?>" required><?php echo $user->shipping_address_1; ?></textarea>                     
                        </div>
                        ...
                        <div class="form-group">
                            <div class="row">
                                ...
                                <div class="col-12 col-md-6">
                                    ...
                                    <div class="selectdiv">
                                        <select id="cities" name="shipping_city" class="form-control" onchange="get_kecamatan_ongkir(this.value);">
                        ...
                        <div class="form-group">
                            <div class="row">
                                <div class="col-12 col-md-6">
                                    ...
                                    <select name="shipping_kecamatan" class="form-control kecamatan_ongkir_edit" onchange="update_product_map();">
                                        <option value="">Kecamatan</option>
                                        <?php
                                        if (!empty($kecamatan)):
                                            foreach ($kecamatan as $item): ?>
                                                <option value="<?php echo $item->id; ?>" <?= ($item->id == $user->shipping_kecamatan) ? 'selected' : '' ?>><?php echo html_escape($item->name); ?></option>
                                            <?php endforeach;
                                        endif; ?>
                                    </select>
                                </div>
