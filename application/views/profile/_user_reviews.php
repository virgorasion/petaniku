            ...
            <div class="reviews">
                <?php if ($review_count > 0): ?>
                    <div class="row-custom review-total">
                        ...
                        <span>(<?php echo get_count_user_rating_from_all_product($user->id); ?>)</span>
                    </div>
                <?php endif; ?>
                    ...
                    <?php foreach ($reviews as $review): ?>
                        <li>
                            ...
                            <div class="right">
                                ...
                                <div class="row-custom">
                                    <a href="<?php echo lang_base_url(); ?><?php echo html_escape($review->product_slug); ?>">
                                        <span class="username"><?php echo $review->title; ?></span>
                                    </a>
                                </div>
