...
<div id="wrapper">
    <div class="container">
        ...
        <div class="row">
            <div class="col-sm-12 <?php echo $col_nav; ?>">
                <!-- load profile nav -->
                <?php if(auth_check()): ?>
                    <?php if (user()->id != $user->id): ?>                
                        <?php $this->load->view("profile/_profile_tabs"); ?>
                    <?php else: ?>
                        <?php $this->load->view("profile/_profile_tabs_normal", ['tabs' => true]); ?>
                    <?php endif; ?>
                <?php else: ?>
                    <?php $this->load->view("profile/_profile_tabs"); ?>
                <?php endif; ?>
            ...
            <div class="col-sm-12 <?php echo $col_content; ?>">
                <div class="tab-content" id="profile-tab-contents">
                    <?php $this->load->view("profile/_profile_tab_contents"); ?>
                </div>
