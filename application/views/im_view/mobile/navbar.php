        ...
        <div class="head-main">
            ...
            <div class="container">
                ...
                <ul id="primary-menu">
                    <!-- #####Begin menu item-->
                    <li class="mega-menu">
                        <a id="profileLink" href="<?=base_url('imuserview/profile')?>" target="_blank">
                            <span class="navUserImg"><img id="userImageTop" src="<?php echo base_url('assets/im/img/download.png') ?>"> </span>
                            <span id="userNameTop" class="bold">John</span>
                        </a>
                    </li>
                    <!-- #####Begin menu item-->
                    <li class="mega-menu"><a href="<?=base_url('imuserview/logout')?>" title="Log Out" class="bold"><span>Log Out</span></a>
                        <!-- #####Begin megamenu-->
                        <!-- #####End megamenu-->
                    </li>
