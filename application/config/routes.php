...
/*product routes*/
$route['loadmore-product'] = 'product_controller/loadmore_homepage';
...
$route['imregistration/register'] = 'IMRegistration/register';
$route['imregistration/login'] = 'IMRegistration/login';
$route['imregistration/adminLogin'] = 'IMRegistration/adminLogin';
$route['imregistration/create_jwt_token'] = 'IMRegistration/create_jwt_token';
$route['imuserview/loginSuccess'] = 'IMUserview/loginSuccess';
$route['imuserview/im'] = 'IMUserview/im';
$route['imuserview/abc'] = 'IMUserview/imbak';
$route['imuserview'] = 'IMUserview/index';
$route['imuserview/imoto'] = 'IMUserview/imoto';
$route['imuserview/profile'] = 'IMUserview/profile';
$route['imuserview/logout'] = 'IMUserview/logout';
$route['imadmin'] = 'IMAdmin/index';
$route['imadmin/loginSuccess'] = 'IMAdmin/loginSuccess';
$route['imadmin/logout'] = 'IMAdmin/logout';
$route['imadmin/dashboard'] = 'IMAdmin/dashboard';
$route['imadmin/user'] = 'IMAdmin/user';
$route['imadmin/messengerOptions'] = 'IMAdmin/messengerOptions';
$route['imadmin/adminSettings'] = 'IMAdmin/adminSettings';
$route['imdownload'] = 'IMDownload/index';
$route['imimage'] = 'IMImage/index';
$route['immobile'] = 'IMMobile/index';
$route['immobile/logout'] = 'IMMobile/logout';
$route['immobile/loginSuccess'] = 'IMMobile/loginSuccess';
$route['immobile/im'] = 'IMMobile/im';
$route['immobile/message'] = 'IMMobile/message';
$route['immobile/info'] = 'IMMobile/info';
$route['immobile/profile'] = 'IMMobile/profile';
$route['imuser/changePassword'] = 'IMUser/changePassword';
$route['imuser/friendList'] = 'IMUser/friendList';
$route['imuser/filterFriendList'] = 'IMUser/filterFriendList';
$route['imuser/friendAdd'] = 'IMUser/friendAdd';
$route['imuser/userProfile'] = 'IMUser/userProfile';
$route['imuser/edit'] = 'IMUser/edit';
$route['imuser/profilePictureUpload'] = 'IMUser/profilePictureUpload';
$route['imApi/getMembers'] = 'ImApi/getMembers';
$route['imApi/getGroupFiles'] = 'ImApi/getGroupFiles';
$route['imApi/deleteMember'] = 'ImApi/deleteMember';
$route['imApi/getUnreadMessageGroups'] = 'ImApi/getUnreadMessageGroups';
$route['imApi/getGroups'] = 'ImApi/getGroups';
$route['imApi/changeGroupName'] = 'ImApi/changeGroupName';
$route['imApi/getMessage'] = 'ImApi/getMessage';
$route['imApi/createGroupByMember'] = 'ImApi/createGroupByMember';
$route['imApi/sendMessage'] = 'ImApi/sendMessage';
$route['imApi/addGroupMember'] = 'ImApi/addGroupMember';
$route['imApi/blockGroup'] = 'ImApi/blockGroup';
$route['imApi/unblockGroup'] = 'ImApi/unblockGroup';
$route['imApi/muteGroup'] = 'ImApi/muteGroup';
$route['imApi/unmuteGroup'] = 'ImApi/unmuteGroup';
$route['imApi/getBlockList'] = 'ImApi/getBlockList';
$route['imApi/leaveGroup'] = 'ImApi/leaveGroup';
$route['imApi/searchMessage'] = 'ImApi/searchMessage';
$route['imApi/searchMessageList'] = 'ImApi/searchMessageList';
